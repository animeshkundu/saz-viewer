...
function App() {
  ...
  return (
    <>
      <div className="h-screen w-screen bg-gradient-to-br from-background via-background to-muted/10 flex flex-col">
        <header className="border-b border-border/20 bg-card/60 backdrop-blur-xl px-8 py-4 shrink-0 elevation-1">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-primary/10 to-secondary/10 border border-primary/15 flex items-center justify-center transition-all hover:scale-105">
                <span className="text-primary font-bold text-sm">SAZ</span>
              </div>
              <h1 className="text-lg font-semibold text-foreground tracking-tight">SAZ Viewer</h1>
            </div>
            <Button
              ...
              className="gap-2.5 h-9 px-4 elevation-1 hover:elevation-2 transition-all hover:scale-[1.02] bg-primary hover:bg-primary/90 text-primary-foreground"
            >
